...
APPROXIMANTS = {
    ...
    'IMRPhenomD_NRTidal': Approximant(tides=True),
    'SEOBNRv4_ROM_NRTidal': Approximant(tides=True),
    'SEOBNRv4_ROM_NRTidalv2': Approximant(tides=True),
    'TaylorF2NLTides': Approximant(tides=True),
